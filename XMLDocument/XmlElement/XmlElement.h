...
* --------------------
* ver 1.7 : 15 Mar 15
* - Added children() and  Attribute() virtual function to AbstractXmlElement 
* and to the crossponding derived classes
* ver 1.6 : 4 Mar 15
* - Added tostring Method for  ProcInstrElement and CommentElement
* ver 1.5 : 22 Feb 15
